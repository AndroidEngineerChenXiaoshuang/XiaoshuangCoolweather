package com.example.administrator.JamCoolWeather.util;
...
public class Utility {
    ...
    public static Weather handleWeatherResponse(String response){
        try{
            ...
            String watherContent = jsonArray.getJSONObject(0).toString();
            return new Gson().fromJson(watherContent,Weather.class);
        }catch (Exception e){
            e.printStackTrace();
        }
        return null;
